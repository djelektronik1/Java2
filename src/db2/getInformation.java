...
public class getInformation extends FactoryInformation
{
    ...
    public String getClients() throws SQLException {
        ...
        while (resultSet.next()){
            ...
            System.out.format("+------------+--+--------------------------------------------------------------------------+\n");
            observer.writeAction(resultSet.getString(1));
            observer.writeAction(resultSet.getString(2));
            observer.writeAction(resultSet.getString(3));
        }
    ...
    public String getProvider() throws SQLException {
        ...
        while (resultSet.next()){
            ...
            observer.writeAction(resultSet.toString());
        }
